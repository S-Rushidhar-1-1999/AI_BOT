    ...
    if True: 
        ...
        if user_id:
            ...
            try:
                ...
                bot.send_message(message.from_user.id, f"response completed")
                ...
                print(error)
                bot.send_message(message.from_user.id, f"entered error")
    else:
        bot.send_message(message.from_user.id, f"entered else")
        return
